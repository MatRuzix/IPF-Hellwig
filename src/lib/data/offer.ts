import type { TextContainerProps } from "@/components/Treatments/components/TreatmentsTextContainer";
...
const offer: TextContainerProps[] = [
  ...
  {
    header: "Osteopatia",
    text: "Osteopatia to holistyczna metoda leczenia, która przywraca równowagę w organizmie poprzez delikatne techniki manualne. Skutecznie pomaga w redukcji bólu, napięć mięśniowych i poprawie mobilności, wspierając naturalne procesy regeneracyjne.",
    secondaryText:
      "Dysfunkcje w obrębie żuchwy | Wady zgryzu | Bóle głowy | Alergie | Problemy żołądkowe | Bóle kręgosłupa",
