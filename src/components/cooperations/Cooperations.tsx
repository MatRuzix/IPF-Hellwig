...
const Cooperations = () => {
  return (
    <div
      className="flex flex-col items-center text-6xl w-full h-[calc(100vh-144px)] bg-gradient-to-b from-slate-100 to-znanylekarzHover pb-2 px-10 overflow-hidden space-y-20"
      id="cooperations"
    >
